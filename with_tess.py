...
# Reading Image
img = cv2.imread("C:\\Users\\Himanshu Bansal\\Desktop\\OpenCV_3_KNN_Character_Recognition_Python-master\\pass\\pic8.jpg")
...
cv2.imshow("new_f",final_image)
cv2.waitKey()
#kernel3x3 = [[-1,-1,-1],[-1,8,-1],[-1,-1,-1]]
#kernel3x3=np.array(kernel3x3)
#final_image = cv2.filter2D(final_image,-1,kernel3x3)
#cv2.imshow("new_f1",final_image)
#cv2.waitKey()
#cv2.waitKey()
